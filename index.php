...
<head>
  ...
  <meta name="description"
    content="Prem Industries India Limited is the top packaging company in India with the best packaging manufacturer like corrugated boxes, pouches, labels, tapes...">
  ...
  <style>
    ...
    .testimonial {
      height: 200px;
      /* Set this to the maximum height of the slide with the most content */
      /* display: flex; */
      align-items: center;
      justify-content: center;
      text-align: center;
...
<body>
  <div>
    ...
    <div id="site-banner" class="carousel slide" data-ride="carousel">
          ...
          <div class="site-banner-content Top25">
            <div class="container">
              <div class="site-banner-content-col">
                ...
                <p class="wow fadeInUp">Your brand deserves the best <a href="https://store.prempackaging.com/"
      ...
      <div class="down__arrow" id="hero-text2">
        <a id="downBtn" href="#textBody"><span></span>
          <div>Scroll Down</div>
        </a>
      </div>
    </div>
            ...
            <div class="Years-of-excellence__slider owl-carousel owl-theme">
              <div class="product-wrap">
                <div class="Years-of-excellence-content">
                  <h3>1977</h3>
                  <p style="font-size: 14px;">Installation of first foot operated corrugation machine and we landed our
                    first client Dabur India in 1977 - A long relationship we still carry.</p>
                </div>
              </div>
              <div class="product-wrap">
                <div class="Years-of-excellence-content">
                  <h3>2005</h3>
                  <p style="font-size: 14px;">This was the year, installation of offset printing machine/Offset printing
                    setup took place</p>
                </div>
              </div>
              <div class="product-wrap">
              ...
              <div class="product-wrap">
                <div class="Years-of-excellence-content">
                  <h3>2012</h3>
                  <p style="font-size: 14px;">2006 to 2012 was our phase of expansion, exploring technologies &
                    advancements for the company.</p>
                </div>
              </div>
              <div class="product-wrap">
                <div class="Years-of-excellence-content">
                  <h3>2013</h3>
                  <p style="font-size: 14px;">New manufacturing facility launched, covering 2 lac sq. ft with state of
                    the art corrugated box setup with machines from industry leading innovators.</p>
                </div>
              </div>
              <div class="product-wrap">
                <div class="Years-of-excellence-content">
                  <h3>2017</h3>
                  <p style="font-size: 14px;">Introduction of rigid box manufacturing segment took place in this year.
                    It was a revolutionary move that added value to our growth & production capacity</p>
                </div>
              </div>
              <div class="product-wrap">
                <div class="Years-of-excellence-content">
              ...
              <div class="product-wrap">
                <div class="Years-of-excellence-content">
                  <h3>2020</h3>
                  <p style="font-size: 14px;">New manufacturing facility launched in Dadri, UP. Spread over 785000 sq.
                    ft with state of the art Sheet metal components setup with machines from industry leading
                    innovators.</p>
                </div>
              </div>
              <div class="product-wrap">
                <div class="Years-of-excellence-content">
                  <h3>2022</h3>
                  <p style="font-size: 14px;">In April we became a Limited Company (tagline). Also, Coating division
                    started that involves the production of label stocks & specialty tapes to start with.</p>
                </div>
              </div>
              <div class="product-wrap">
                <div class="Years-of-excellence-content">
                  <h3>2024</h3>
                  <p style="font-size: 14px;">State-of-the-art setup is being developed for our Dadri unit in four
                    phases, with Phase 1 already completed.</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="body__content padding second">
    <div class="container">
      ...
      <div class="row mt-60">
        <div class="col-md-6 order2">
          <div class="design-content">
            ...
            <p class="wow fadeInUp">We are manufacturer of all kinds of packaging solutions, including <a
                href="https://www.store.prempackaging.com/corrugated-boxes" target="_blank"
                style="color: #555555">corrugated
                boxes</a>, luxury boxes, flexible laminates, mono cartons, <a
                href="https://www.store.prempackaging.com/" target="_blank" style="color: #555555">e-com packaging</a>,
              outer cartons, carry bags, <a href="https://www.store.prempackaging.com/food-wrapping-paper"
                target="_blank" style="color: #555555">PackPro<sup>™</sup> Food Wrapping Paper</a>, PackPro<sup>™</sup>
              Carry Handle Tape, WetBoxTech<sup>™</sup>, Flexpand<sup>™</sup>, <a
                ...
                style="color: #555555">Rollabel<sup>™</sup> Labels,</a> etc. Our mission as a small start up in 1976 was
              simple: to tailor a
              company with the flexibility to fill orders of all sizes and to consistently provide our customers with a
              superior product.</p>
            <a href="corrugated-packaging.php" class="more-btn mt-4"><i class="fa fa-clone" aria-hidden="true"></i> Read
              More</a>
          </div>
        </div>
      ...
      <div class="row mt-60">
        <div class="col-md-6 order2">
          <div class="design-content">
            ...
            <p class="wow fadeInUp">Packaging is a crucial component of a brand's concept, whether the customer is a
              prestige shopper or purchasing a gift. When it comes to packaging, rigid boxes are frequently the last
              thing that people consider, but when it comes to luxury goods, rigid box packaging is actually a highly
              popular option. We use technology to craft it elegantly for you!</p>
            <a href="luxury-packaging.php" class="more-btn mt-4"><i class="fa fa-clone" aria-hidden="true"></i> Read
              More</a>
          </div>
        </div>
        <div class="col-md-6 order1">
      ...
      <div class="row mt-60">
        ...
        <div class="col-md-6 order2">
          <div class="design-content inovations">
            <h3 class="wow fadeInUp">Our Solution is Flexible</h3>
            <p class="wow fadeInUp">By enabling the development of packaging that can adapt to the unique requirements
              of each product, flexible packaging is a technologically advanced and versatile solution that aids in
              enhancing the quality and visibility of the items. Take into account the benefits of packaging that may
    ...
    <div class="row">
      <div class="col-lg-8 offset-lg-2">
        <div class="Sustainability_ConentP text-center">
          ...
          <p class="wow fadeInUp paddingLR" style="font-size: 16px;">We solve the biggest packaging challenges of our
            customers with an innovative approach and leading technology and we are the best packaging manufacturer. We
            have a
            team under R & D who deals with premium quality materials, packaging designs & technical aspects. Our team
            manages machinery and automation with a digital approach to ensure the best output.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="Sustainability_ConentP mt-5 pt-5">
    <div class="container">
      <div class="row">
        <div class="col-md-8 offset-md-2 text-center">
          <div class="position-relative" style="z-index: 1;">
            <h2 class="wow fadeInUp" style="font-size: 42px;">We are keeping it 'Green'</h2>
            <p class="wow fadeInUp" style="font-size: 16px;">Our vision is to be the best packaging company in India and
              the world, driving everything we do. We’re innovating to help our customers reach their sustainability
              goals and win in the market. We’re setting science-based goals to reduce greenhouse gas emissions.
              Stewarding natural resources & using material that can be recycled, reused or decomposed. We are working
              towards 100% safety & becoming an employer of choice. </p>
            <p class="wow fadeInUp" style="font-size: 16px;">Through these and many other efforts, we aim to help our
              business, our customers, our team members, our investors and our communities realize the promise of a
              sustainable future. </p>
            <p style="font-size: 16px;">We are crafting paper packaging and recycling the plastic. With our team
              recycled over 2000 tonnes of plastic in the last three years, averaging 50 tonnes per month.</p>
          </div>
  ...
  <section>
    <div class="container mt-5">
      <div class="row">
        ...
        <div class="col-md-8">
          <iframe width="100%" height="315" src="https://www.youtube.com/embed/sgXaThtSFNY" frameborder="0"
  ...
  <div class="container mb-5">
    <div class="row mt-5">
      <div class="col-md-12">
        <h1 class="text-center mt-3 align-center" style="font-size: 42px; color: #3A5BA2; font-weight: 700">Testimonials
        </h1>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="new-arrivals__slider owl-carousel owl-theme">
          <div class="product-wrap">
            <p class="mt-5 text-center">We're satisfied with Prem Industries India Limited's pouches for our whey
              protein. The quality is good which keeps our products fresh and safe. Whenever we need something, they're
              there for us. The team is great and we're looking forward to working with them in the futures.</p>
          ...
          <div class="product-wrap">
            <p class="mt-5 text-center">We commend Prem Industries India Limited for their impeccable craftsmanship and
              timely delivery of superior rigid boxes. With their packaging solutions, our products now stand out on
              shelves, ensuring prolonged freshness and customer satisfaction . We appreciate their dedication to
              excellence and commitment to delivering exceptional packaging solutions. Highly recommended!</p>
            <h4 class="text-center"> - NutField</h4>
          </div>
          <div class="product-wrap">
            <p class="mt-5 text-center">I'm thrilled with the quality and durability of the pouches I purchased. They've
              been perfect for my nut packets, keeping them fresh and appealing to customers. The sleek design and
              sturdy material enhanced the overall presentation of my product. Highly recommend their pouches for any
              packaging needs.</p>
          ...
          <div class="product-wrap">
            <p class="mt-5 text-center">Your commitment to delivering our recent Costco shipment was exemplary. The
              timely delivery and exceptional material quality exceeded our expectations. Your team's professionalism
              and attention to detail have greatly enhanced our trust in your services and contributed to our success.
              It’s a pleasure to partner with such a reliable team. Thank you for your unwavering dedication. We look
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="Client_Content">
            <h5>Our Happy Partners</h5>
            <h3 class="mt-4">We have many clients worldwide</h3>
        ...
        <div class="col-lg-6 offset-lg-1">
          <section class="clients padding wow fadeIn">
            <div class="container">
              <div class="white-bg">
                <div class="row">
                  <div class="col-lg-12">
                    <p style="font-size: 16px;">We began our packaging journey with Dabur in 1977 and since then there
                      is no looking back. We have been a flourishing enterprise ever since.</p>
          ...
          <!-- <div class="Cliets_Logo">
            ...
            <div class="Logos_Row clearfix">
              ...
              <div class="Logo_IMG">
                <img src="img/logo/2.png" alt="flipkart" title="" />
              </div>
              <div class="Logo_IMG">
                <img src="img/logo/3.png" alt="vivo" title="" />
              </div>
              <div class="Logo_IMG">
                <img src="img/logo/4.png" alt="wipro" title="" />
              </div>
              <div class="Logo_IMG">
                <img src="img/logo/5.png" alt="bikano" title="" />
              </div>
              <div class="Logo_IMG">
              ...
              <div class="Logo_IMG">
                <img src="img/logo/10.png" alt="hindware" title="" />
              </div>
              <div class="Logo_IMG">
                <img src="img/logo/11.png" alt="itc" title="" />
              </div>
              <div class="Logo_IMG">
          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <div class="text-center mb-0 pb-0">
                ...
                <p class="wow fadeInUp">We have received certifications from credible quality management authorities to
                  prove our authentic presence in this industry.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">
    /* years of ex */
    $('.Years-of-excellence__slider').owlCarousel({
      loop: true,
      nav: false,
      dots: true,
      autoplay: true,
    ...
    $('.new-arrivals__slider').owlCarousel({
      loop: true,
      nav: false,
      dots: true,
      autoplay: true,
