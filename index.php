      ...
      <div class="row mt-60">
        <div class="col-md-6 order2">
          <div class="design-content">
            ...
            <p class="wow fadeInUp">We are manufacturer of all kinds of packaging solutions, including <a href="https://www.store.prempackaging.com/corrugated-boxes" target="_blank" style="color: #555555">corrugated
              boxes</a>, luxury boxes, flexible laminates, mono cartons, <a href="https://www.store.prempackaging.com/" target="_blank" style="color: #555555">e-com packaging</a>, outer cartons, carry bags, <a href="https://www.store.prempackaging.com/food-wrapping-paper" target="_blank" style="color: #555555">PackPro<sup>™</sup> Food Wrapping Paper</a>, PackPro<sup>™</sup> Carry Handle Tape, WetBoxTech<sup>™</sup>, Flexpand<sup>™</sup>, <a href="https://www.store.prempackaging.com/tape" target="_blank" style="color: #555555">PackPro<sup>™</sup> Tapes</a>, <a href="https://www.store.prempackaging.com/label" target="_blank" style="color: #555555">Rollabel<sup>™</sup> Labels,</a> etc. Our mission as a small start up in 1976 was simple: to tailor a
      ...
      <div class="row mt-60">
        ...
        <div class="col-md-6 order2">
          <div class="design-content inovations">
            ...
            <p class="wow fadeInUp">Packaging for e-commerce is more than protecting and preserving the product. A greater grasp of consumer lifestyle trends, consumer habits, and retail transformations that affect the consumer experience is the first step...</p>
            <a href="E-commerce-packaging.php" class="more-btn mt-4"><i class="fa fa-clone" aria-hidden="true"></i> Read More</a>
          </div>
        </div>
      </div>
      <div class="row mt-60">
