...
<head>
  ...
  <meta name="description"
    content="Explore hygienic, durable healthcare packaging for wipes, pouches & masks. Trusted by top brands. Connect with a top healthcare packaging manufacturer today.">
  <meta property="og:title" content="Healthcare Packaging | Prem Industries India Limited">
  ...
  <title>Healthcare Packaging Manufacturer</title>
...
<body>
  ...
  <!-- <div class="page-hero pageheade"
    style="background: #eee url(../img/healthcare-packaging/pagebanner.png); height: 350px; background-size: cover; background-position: center;">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <h1>Healthcare Packaging</h1>
        </div>
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#"><i class="fa fa-home"></i> Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Healthcare Packaging</li>
            </ol>
          </nav>
        </div>
      </div>
  ...
  <img src="img/common-banners/healthcare-packaging.jpg" alt="Healthcare Packaging" class="img-fluid w-100 shadow-sm">
  ...
  <section class="body__content mt-5 page-body-content">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div>
            <h3 class="wow fadeInUp" style="font-size: 35px">Trusted Healthcare Packaging for a Healthier Tomorrow</h3>
          </div>
        </div>
      </div>
      <div class="row m-0 p-0">
        <div class="col-md-12 m-0 p-0" style="text-align: justify">
          <div class="body-content">
            <div class="body-content">
              <p class="wow fadeInUp">At Prem Industries India Limited, we understand the importance of safety, hygiene,
                and compliance in the healthcare industry. Our specialized healthcare packaging solutions are designed
              ...
              <p class="wow fadeInUp">Our team works closely with clients to develop packaging that reflects both brand
                trust and consumer convenience.</p>
              <h4 style="font-weight: 600;">Tailored Solutions for Brands that Care</h4>
              <p class="wow fadeInUp">Whether you're a pharmaceutical company, a personal care startup, or an e-commerce
                healthcare brand, we create packaging that not only protects but also elevates your product. With
                end-to-end support from design to delivery, our packaging solutions offer unmatched quality,
