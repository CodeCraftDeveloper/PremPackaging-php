...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="Electronic Packaging Manufacturer | Prem Industries India Limited">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PSMKSG4F96"></script><script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-PSMKSG4F96'); </script>
    ...
    <title>Electronic Packaging Manufacturer</title>
      ...
      <div class="row mt-60">
        ...
        <div class="col-md-6 order1">
          <div class="design-image wow" data-wow-delay="0.5s">
            <img class="image1" width="665" height="870" src="img/media-electronics-i.jpg" alt="Electronic Packaging" title="" />
          </div>
        </div>
      </div>
    </div>
