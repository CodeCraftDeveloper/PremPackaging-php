...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Prem Industries India Limited offers cutting-edge electronic packaging solutions. Explore our innovative designs for secure and stylish electronic packaging.">
    <meta property="og:title" content="Best Electronic Packaging Solutions | Prem Industries India Limited">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PSMKSG4F96"></script><script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-PSMKSG4F96'); </script>
    ...
    <title>Best Electronic Packaging Solutions | Prem Industries India Limited</title>
  ...
  <body>
    ...
    <div class="page-hero pageheade media-pack-b">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>Custom Boxes Designed to Bridge Safe Products & Better Experience</h1>
          </div>
          <div class="col-md-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Electronics Packaging</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div class="col-md-6 order2">
          <div class="body-content">
            ...
            <ul class="listing-content">
              ...
              <li><i class="fa fa-arrow-right"></i> Choose from a huge range of pack formats that fit your needs, like rigid boxes, printed boxes, labels, sleeves, etc.</li>
              <li><i class="fa fa-arrow-right"></i> Integrated merchandise displays and product packaging design.</li>
              <li><i class="fa fa-arrow-right"></i> Retail displays from design to production.</li>
            </ul>
            <p>Our advanced approach and machinery continue to amaze the customers with innovation, cost reduction, and enhancement of product display.</p>

          </div>
        </div>
        <div class="col-md-6 order1">
          <div class="design-image wow" data-wow-delay="0.5s">
            <img class="image1" width="665" height="870" src="img/media-electronics-i.jpg" alt="" title="" />
          </div>
        </div>
      </div>
    </div>
