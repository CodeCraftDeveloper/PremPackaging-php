    ...
    <div class="container highlight-txt">
      <div class="row">
        <div class="col-md-6 order2">
          <div class="body-content">
            <h3>Mission</h3>
            <p class="wow fadeInUp">To be one of India’s leading packaging solution providers. <br> To be a customer driven company with strong focus on:</p>
            <ul class="mb-3">
              <li style="font-size: 15px; font-weight: 500; line-height: 26px;"><i class="fa fa-arrow-right"></i> Customer’s needs and total satisfaction</li>
              <li style="font-size: 15px; font-weight: 500; line-height: 26px;"><i class="fa fa-arrow-right"></i> Continuous technological upgradations and process enhancements to keep up with the latest paper packaging solutions.</li>
            </ul>
      ...
      <div class="row mt-60 pt-5">
        ...
        <div class="col-md-6 order2">
          <div class="body-content">
            <h3>Vision</h3>
            <p class="wow fadeInUp">To be a trendsetter in the Indian packaging and manufacturing industry offering both <span>Class Leading Services</span> & <span>  Innovative Products.</span></p>
            <h4 style="font-weight: 600; color: #14254C;">Our Values</h4>
            <ul class="mb-3">
              <li style="font-size: 15px; font-weight: 500; line-height: 26px;"><i class="fa fa-arrow-right"></i> We value, challenge and reward our <span>PEOPLE</span>.</li>
              <li style="font-size: 15px; font-weight: 500; line-height: 26px;"><i class="fa fa-arrow-right"></i> We put our <span>CUSTOMERS</span> at the centre of what we do.</li>
              <li style="font-size: 15px; font-weight: 500; line-height: 26px;"><i class="fa fa-arrow-right"></i> We drive excellent sustainable <span>FINANCIAL PERFORMANCE</span>.</li> 
              <li style="font-size: 15px; font-weight: 500; line-height: 26px;"><i class="fa fa-arrow-right"></i> We are committed to leadership in <span>SUSTAINABILITY</span>.</li> 
              <li style="font-size: 15px; font-weight: 500; line-height: 26px;"><i class="fa fa-arrow-right"></i> We build our future on <span>FAMILY BUSINESS</span> foundation.</li> 
            </ul>
