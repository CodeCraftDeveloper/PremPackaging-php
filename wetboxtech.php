...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Discover WetBox Tech™: Innovative, recyclable packaging solutions for wet and humid environments, ensuring sustainability and durability.">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PSMKSG4F96"></script><script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-PSMKSG4F96'); </script>
  ...
  <body>
    ...
    <div class="page-hero pageheade" style="background: #eee url(../img/wetboxtech-banner-img.jpg); height: 350px; background-size: cover; background-position: center;">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
