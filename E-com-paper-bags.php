...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PSMKSG4F96"></script><script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-PSMKSG4F96'); </script>
  ...
  <body>
    ...
    <div class="page-hero pageheade e-com-paper">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>Customizable & Eco-friendly Packaging is the Future</h1>
          </div>
          <div class="col-md-12">
      ...
      <div class="row mt-60">
        <div class="col-md-6 order2">
          <div class="body-content">
            <p class="wow fadeInUp">When it comes to e-com, we are your one-stop shop! E-commerce is being lead by paper bags and we are focused to offer innovative solutions for the same. With 44 years of experience in the paper industry, Prem provides the right choice of paper packaging. We were the first company to make paper bags commercially viable. We are manufacturing a feasible range of paperboard mailers, envelop and paper bags. Less waste, right-sized packaging and sustainable growth is all we are trying to achieve with this category of packaging.</p>

            <p>We are crafting fashionable, versatile, and affordable online retail packaging. Your consumers demand great user experience, sustainability and assurance of safety. Prem Industries India Limited e-com paper bags deliver on all accounts.</p>

          </div>
        </div>
        <div class="col-md-6 order1">
          <div class="design-image wow" data-wow-delay="0.5s">
            <img class="image1" width="665" height="870" src="img/papper-bag.jpg" alt="" title="" />
          </div>
        </div>
      </div>
    </div>
