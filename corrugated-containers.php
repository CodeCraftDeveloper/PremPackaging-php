...
<head>
  ...
  <meta name="description"
    content="Discover our strong corrugated containers for secure product packaging. Choose reliability with Prem Industries India Limited. Contact us now!">
      ...
      <div class="row" style="text-align: justify">
        <div class="col-md-6 order2">
          <div class="body-content">
            ...
            <p>Our integrated packaging solutions include the Packaging Consulting Group, which will evaluate your
              production line and recommend technology-based packaging efficiencies. Furthermore, we will suggest ways
              to maximise, simplify, or modify your container designs in order to optimise packaging and processes.</p>
          </div>
        </div>
        <div class="col-md-6 order1 mt-4">
