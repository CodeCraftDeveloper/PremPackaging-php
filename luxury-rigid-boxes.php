...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Elevate your brand with Prem Industries India Limited's luxury rigid boxes. Crafted for elite packaging solutions. Discover luxury rigid boxes today.">
    <meta property="og:title" content="Luxury Rigid Boxes for Elite Packaging| Prem Industries India Limited">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PSMKSG4F96"></script><script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-PSMKSG4F96'); </script>
    ...
    <title>Luxury Rigid Boxes for Elite Packaging | Prem Industries India Limited</title>
  ...
  <body>
    ...
    <div class="page-hero Luxury-Rigid-Boxes pageheade">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>Luxury Rigid Boxes</h1>
          </div>
          <div class="col-md-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="fa fa-home"></i> Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Luxury Rigid Boxes</li>
              </ol>
            </nav>
          </div>
        </div>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-md-8 p-1">
            <a class="gallery-col" href="img/middle-open-box-mockup-opened-and-closed.jpg" data-fancybox="images">
