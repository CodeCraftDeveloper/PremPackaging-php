...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Elevate your personal care products with Prem Industries India Limited's customized packaging solutions. Trust us for premium personal care packaging.">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PSMKSG4F96"></script><script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-PSMKSG4F96'); </script>
    ...
    <title>Personal Care Packaging Solutions | Prem Industries India Limited</title>
