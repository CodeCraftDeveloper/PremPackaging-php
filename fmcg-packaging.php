...
<body>
  ...
  <img src="img/common-banners/fmcg-packaging.jpg" alt="FMCG Packaging" class="img-fluid w-100 shadow-sm">
      ...
      <div class="row mt-3">
        <div class="col-md-6 order2 mb-3" style="text-align: justify">
          <div class="body-content">
            ...
            <p class="wow fadeInUp">Our advanced printing technologies and high-quality inks set us apart in the FMCG
