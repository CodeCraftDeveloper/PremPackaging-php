...
<div>
    <a href="https://www.facebook.com/PremIndustriesIndiaLimited/" target="_blank" rel="noreferrer" class="shadow-lg"
        aria-label="Facebook">
        <button class="btn sticky-button p-2 bg-primary text-white" type="button">
            <i class="fa-brands fa-facebook fa-2xl"></i>
        </button>
    </a>
    <a href="https://www.instagram.com/prem_industries_india/" target="_blank" rel="noreferrer" class="shadow-lg"
        aria-label="Instagram">
        <button class="btn sticky-button-3 p-2 text-white" style="background-color: #F40F56" type="button">
            <i class="fa-brands fa-instagram fa-2xl"></i>
        </button>
    </a>
    <a href="https://in.linkedin.com/company/prem-packaging" target="_blank" rel="noreferrer" class="shadow-lg"
        aria-label="LinkedIn">
