        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown megamenu-li dmenu">
            <a class="nav-link dropdown-toggle" href="" id="dropdown01" data-toggle="dropdown" aria-haspopup="true"
              aria-expanded="false">Packaging Solutions</a>
            <div class="dropdown-menu megamenu sm-menu p-0 m-0" aria-labelledby="dropdown01" style="z-index: 999">
              <div class="row">
                <div class="col-sm-6 col-lg-6 border-right">
                  ...
                  <a class="dropdown-item" href="beauty-personal-care-packaging.php">Beauty & Personal Care<br />
                    Packaging</a>
            ...
            <div class="dropdown-menu megamenu sm-menu border-top p-0 m-0" aria-labelledby="dropdown01"
              ...
              <div class="row">
                ...
                <div class="col-sm-4 col-lg-4">
                  ...
                  <a class="dropdown-item" href="offset-printed-cartons-folding-cartons.php">Offset Printed Cartons /
