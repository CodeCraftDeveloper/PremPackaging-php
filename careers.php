...
<head>
  ...
  <meta name="description"
    content="Explore exciting career opportunities at Prem Industries India Limited. Join a dynamic team committed to innovation in packaging solutions. Ready to Shape the Future of Packaging? Apply Now!">
  ...
  <section class="body__content padding page-body-content">
    <div class="container">
      <div class="row align-items-center m-0">
        <div class="col-md-12 position-center-top"
          style="background: url(img/happy-young-man-starting-career-in-business.jpg);">
          <div class="careers-content">
            <p><strong>Making a team of talented individuals who share our company's mission and values is critical to
                Prem Industries India Limited's global success.</strong></p>
            <p>We collaborate closely with our customers to create innovative methods of promoting, displaying, and
              protecting their products in order to establish long-term relationships with consumers. Our emphasis on
              long-term relationships and a consumer-centric approach encourage innovative thinking and new solutions in
              every industry.</p>
            <p>Focusing on the success of our customers provides us with numerous opportunities to advance our careers.
                ...
                <form id="careerForm" method="POST" enctype="multipart/form-data">
                  <div class="form-row clearfix">
                    ...
                    <div class="form-group col-md-6 col-sm-12">
                      ...
                      <input type="tel" class="form-control" name="mobile" placeholder="Your 10 Digit Phone Number"
                        required />
                      <span class="error-message"></span>
                    </div>
                  </div>
                  ...
                  <div class="form-row clearfix">
                    ...
                    <div class="form-group col-md-6 col-sm-12">
                      ...
                      <input type="text" class="form-control" name="position" placeholder="Designation Applying For"
                        required />
                    </div>
                  </div>
                  ...
                  <div class="form-row clearfix">
                    <div class="form-group col-md-6 col-sm-12">
                      <label><b>Upload your Resume</b><span class="text-danger">*</span> <b>(PDF under 100 KB
                          Only)</b></label>
                  ...
                  <div class="row clearfix">
                    <div class="col-md-12 col-sm-12"
                      ...
                      <input type="submit" class="btn btn-primary btn-lg" value="Submit Details"
                        style="margin-top: 15px; margin-bottom: 15px; background-color: #14254C;" />
                    </div>
                  </div>
                </form>
              </div>
