...
<head>
  ...
  <meta name="description"
    content="Stay ahead with cutting-edge packaging technology from Prem Industries India Limited. Elevate your packaging process with our latest innovations. Upgrade now for efficiency!">
...
<body>
  ...
  <img src="img/common-banners/packaging-technology.jpg" alt="Packaging Technology" class="img-fluid w-100 shadow-sm">
      ...
      <div class="row mt-60">
        ...
        <div class="col-md-6 order1">
          <div class="design-image wow" data-wow-delay="0.5s">
            <img class="image1" width="665" height="870" src="img/packaging-technology-r.jpg"
          ...
          <div class="card mt-3 tab-card rounded-0">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active p-4" id="one" role="tabpanel" aria-labelledby="one-tab">
                <div class="row align-items-center">
                  <div class="col-md-8 offset-md-2 text-center">
                    <p class="card-text">We focus on the actual product requirements of every customer, and our expert
                      team of R&D uses its rich experience in deciding the tailor-made product designs.</p>
                  </div>
                  <div class="col-md-4">
              ...
              <div class="tab-pane fade p-4" id="three" role="tabpanel" aria-labelledby="three-tab">
                <div class="row align-items-center">
                  <div class="col-md-8 offset-md-2 text-center">
                    <p class="card-text">We have equipped ourselves with the latest processing equipment, innovative and
                      advanced product building and printing technology to meet the unique demands of our customers.</p>
                  </div>
                  <div class="col-md-4">
                    <div class="design-image">
                      <!--  <img class="" width="665" height="870" src="img/desing-image.jpg" alt="" title="" /> -->
                ...
                <div class="row align-items-center">
                  <div class="col-md-8 offset-md-2 text-center">
                    ...
                    <p class="card-text">We offer expertise in packaging design at low costs and the latest technology
                      ...
                      advanced manufacturing plants offer the latest in-house manufacturing potential. We cater to the
                      needs of all our customers in large volumes, while also ensuring we maintain high-quality
                      standards.</p>
                  </div>
                  <div class="col-md-4">
                    <div class="design-image">
          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <div class="text-center">
                ...
                <p class="wow fadeInUp mb-0 pb-0">We have received certifications from credible quality management
                  authorities to prove our authentic presence in this industry.</p>
              </div>
            </div>
          </div>
