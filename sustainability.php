...
<head>
  ...
  <meta name="description"
    content="If you are looking for sustainable packaging solutions, Prem Industries India Limited is one of the best packaging manufacturers. Our focus is sustainable, and effective packaging.">
...
<body>
  ...
  <img src="img/common-banners/sustainability.jpg" alt="Sustainability" class="img-fluid w-100 shadow-sm">
      ...
      <div class="row mt-5">
        <div class="col-md-6 order2">
          <div class="body-content">
            <p class="wow fadeInUp">As we work towards creating the best customer experience, we also ensure that
              ...
              thoughtfully.</p>
            <p> Our team undertakes environmentally conscious measures which are implemented along with the suppliers,
              technicians, business partners, etc. Out of the many measures we take, here are some:</p>
            <ul class="listing-content">
              ...
              <li><i class="fa fa-arrow-right"></i> We also offer our customers the option to switch towards an
                eco-friendly approach when they choose the packaging options for their brands.</li>
        ...
        <div class="col-md-6 order1 mt-5 mb-2">
          <div class="design-image wow" data-wow-delay="0.5s">
            <img class="image1" width="665" height="870" src="img/sustainability/side-img.jpg"
  ...
  <div class="e-commerce-gallery BoxesGallery mt-3">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <h3 class="wow fadeInUp animated text-center mb-5 mt-2"
            style="color: #14254c; text-transform: uppercase; font-size: 34px; font-weight: bold;">Explore Our
            Sustainable Packaging Range</h3>
        </div>
        ...
        <div class="col-md-3 p-1">
          <a class="gallery-col" href="img/sustainability/cards/7.png" data-fancybox="images">
            <div class="gallery-box">
              <h4 class="text-center" style="align-items: flex-end; font-size: 20px;">Padded Mailer Bag with Customized
                Reinforcement</h4>
