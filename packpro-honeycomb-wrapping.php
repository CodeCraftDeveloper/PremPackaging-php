...
<html lang="en">
  <head>
    ...
    <meta name="description" content="PackPro Honeycomb Wrapping">
    <meta property="og:title" content="PackPro Honeycomb Wrapping | Prem Industries India Limited">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-PSMKSG4F96"></script><script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-PSMKSG4F96'); </script>
    ...
    <title>PackPro Honeycomb Wrapping</title>
  ...
  <body>
    ...
    <div class="page-hero pageheade" style="background: #eee url(../img/packpro-honeycomb-wrapping/banner.png); height: 350px; background-size: cover; background-position: center;">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>PackPro<sup>™</sup> <br>Honeycomb Wrapping</h1>
          </div>
          <div class="col-md-12">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="fa fa-home"></i> Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">PackPro™ Honeycomb Wrapping</li>
              </ol>
            </nav>
          </div>
        </div>
